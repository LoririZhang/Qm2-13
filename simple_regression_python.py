...
data_filename = 'Edu_spend_attatinRate_reg.csv'

# In the next line, replace boxplot with the filename you wish to save as:
output_filename = 'Edu_spend_attatinRate_reg.png'
...
plt.title('Comparison of the Education Spending per studnet \nand Higher education attainment rate of each States in USA in 2021')
plt.xlabel('Education Spending per studnet for K-12 and postgraduate in $')
plt.ylabel('Higher education attainment rate')
